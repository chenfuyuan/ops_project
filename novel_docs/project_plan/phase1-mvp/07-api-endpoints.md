...
```
GET    /api/v1/llm/profiles                  获取所有模型配置
POST   /api/v1/llm/profiles                  创建模型配置
PUT    /api/v1/llm/profiles/{id}             更新模型配置
DELETE /api/v1/llm/profiles/{id}             删除模型配置
POST   /api/v1/llm/profiles/{id}/test        测试模型连接
```
...
### POST /api/v1/llm/profiles/{id}/test
